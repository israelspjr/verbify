		...
		<fieldset id="fs_addquestion">
			...
			<div id="tabs" style="margin-top: 10px;">
				...
				<div id="tabs-1">
					...
					<div id="dv_form_respostas"></div>
				</div>
				<div id="tabs-2">
					<div>
						<label>Tópico</label><br />
						<input name="topico_en" maxlength="300" class="iptresposta" value="" />
						<span class="error"><?=Arr::get($errors, "topico_en")?></span>
					</div>
					<div>
						<label>Enunciado</label><br />
						<textarea class="questao" name="questao_en"></textarea>
						<span class="error"><?=Arr::get($errors, "enunciado_en")?></span>
					</div>
					<div id="dv_form_respostas_en"></div>
				</div>
			</div>
			<div class="clear"></div>
			<div>
