...
<p>Avaliamos o que realmente importa.</p>					
				...
				<div class="dvsao_graduacoes">
					...
					<ul>
						...
						<li>
							...
							<div class="ipt">
								...
								<label >
									...
									<input type="radio" name="situacao['.$i.']" value="4" groupname="situacao'.$i.'" class="situacao" '.($grad->situacao==4 ? 'checked': '').' />
						...
						<li>
							...
							<input type="text" name="grad_dtini['.$i.']" class="mes ipt ini" value="'.Helper::format_date_to_mes($grad->dt_inicio).'" /> 
...
<script type="text/javascript">
	...
	function setSituacao(el){
		...
		if(value == 3){
		    ...
		    $(el).parents('.dvsao_graduacoes').find('.ini').val('').attr('disabled', 'disabled');
